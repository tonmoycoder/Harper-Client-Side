        ...
        <div className='max-w-6xl mx-auto mt-8'>
            ...
            <div className='grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                <div className='px-5'>
                    ...
                    <p className='paragraph text-lg '>Left your charger or keys at home? Have it delivered to you on Harper Parcel, without any hassle!</p>
                </div>
                <div className='px-5'>
                    ...
                    <p className='paragraph text-lg '>You can trust us to deliver your most confidential documents to the desired place absolutely intact right on time!</p>
                </div>
                <div className='px-5'>
                    ...
                    <p className='paragraph text-lg '>With Harper Parcel, you can get your item in the quickest time. Because your emergencies are Parcel&apos;s biggest concern!</p>
                </div>
            </div>
        </div>
    );
