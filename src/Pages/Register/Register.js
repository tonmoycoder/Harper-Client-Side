    ...
    <div className="poppins">
      <div className="register-main flex justify-center items-center mt-20 px-4 mb-20">
        <form className="w-[20rem] text-left" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="mb-2 text-white bg-orange-500 font-general hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 lg:w-full">
            Sign Up
          </button>
          <Link
            to="/login"
